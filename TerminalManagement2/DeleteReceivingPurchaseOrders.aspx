<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeleteReceivingPurchaseOrders.aspx.vb" Inherits="KahlerAutomation.TerminalManagement2.DeleteReceivingPurchaseOrders" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html>
<html lang="en">
<head id="Head1" runat="server">
	<title>Purchase Orders : Delete Orders</title>
			...
			<ContentTemplate>
					...
					<div class="sectionOdd">
						<ul>
							<li>
								...
								<asp:CheckBox ID="cbxShowCompleted" runat="server" Text="Show completed only" />
							</li>
							<li>
								<label>
									&nbsp;
				...
				<div id="pnlOrdersArea" class="section">
					<asp:Panel ID="pnlOrders" runat="server">
						<h1>Receiving Purchase Orders</h1>
