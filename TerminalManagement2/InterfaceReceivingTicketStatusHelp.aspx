<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InterfaceReceivingTicketStatusHelp.aspx.vb" Inherits="KahlerAutomation.TerminalManagement2.InterfaceReceivingTicketStatusHelp" EnableViewState="false" %>

<!DOCTYPE html>
<html lang="en">
<head id="Head1" runat="server"><title>Help : Interface Receiving Ticket Export Status</title>
	<link href="helpstyle.css" type="text/css" rel="stylesheet" />
</head>
<body>
	<form id="InterfaceReceivingTicketStatusHelp" runat="server">
		<div><span style="font-size: large; font-weight: bold;"><a href="help.aspx#Interfaces">Help</a>: Interface Receiving Ticket Export Status</span><hr style="width: 100%; color: #003399;" />
			<div id="divHelp">
				...
				<table>
					...
					<tr>
						<td><span class="helpItem" style="margin-left: 30px;">Tickets without errors:</span> will show tickets that have not been exported, and that have not been marked as having an error in the database. Some interfaces use this method to try and export a ticket, and if there is an issue, it will "Black List" the ticket by marking it with an error.</td>
					</tr>
					<tr>
						<td><span class="helpItem" style="margin-left: 60px;">Only include purchase orders assigned for this interface:</span> will only show tickets that were completed when the purchase order was marked as being created by the interface. If unchecked, it will include all tickets for any purchase order, regardless of the source of the purchase order.</td>
					</tr>
					<tr>
						<td><span class="helpItem" style="margin-left: 30px;">Include tickets with errors:</span> will show tickets that have not been exported, but have been marked as having an error in the database. Some interfaces use this method to try and export a ticket, and if there is an issue, it will "Black List" the ticket by marking it with an error.<br />
					...
					<tr>
						<td><span class="helpItem" style="margin-left: 30px;">Include tickets with ignored errors:</span> will show tickets that have not been exported, but have been marked as having an error in the database, and have had the error marked as ignored.</td>
					</tr>
				</table>
				<hr />
				<table>
