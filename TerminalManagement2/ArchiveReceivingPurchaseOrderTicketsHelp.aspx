<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ArchiveReceivingPurchaseOrderTicketsHelp.aspx.vb" Inherits="KahlerAutomation.TerminalManagement2.ArchiveReceivingPurchaseOrderTicketsHelp" EnableViewState="false" %>

<!DOCTYPE html>
<html lang="en">
<head runat="server">
	<title>Help : Archive Receiving Purchase Order Tickets</title>
	<link href="helpstyle.css" type="text/css" rel="stylesheet" />
</head>
<body>
	<form id="ArchiveReceivingPurchaseOrderTicketsHelp" runat="server">
		<div>
			<span style="font-size: large; font-weight: bold;"><a href="help.aspx#ArchiveReceivingPurchaseOrderTickets">Help</a>: Archive Receiving Purchase Order Tickets</span>
			<hr style="width: 100%; color: #003399;" />
			<div id="divHelp">
				<p>The archive tickets page may be used to archive/unarchive as well as void multiple tickets at the same time.</p>
				...
				<p><span class="helpItem">Supplier drop-down list:</span> list containing all the suppliers set up in the system. If a particular supplier is selected, then only the tickets that are associated with that supplier will be displayed.</p>
				<p><span class="helpItem">Facility drop-down list:</span> contains all the facilities set up in the system. If a particular facility is selected, then only the tickets that are associated with that facility will be displayed.</p>
