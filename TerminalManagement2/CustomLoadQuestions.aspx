<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CustomLoadQuestions.aspx.vb" Inherits="KahlerAutomation.TerminalManagement2.CustomLoadQuestions" %>

<!DOCTYPE html>
<html lang="en">
<head>
	<title>Facilities : Custom Load Questions</title>
...
<body>
	<form id="main" method="post" runat="server" defaultfocus="tbxName">
		...
		<asp:Panel ID="pnlDetails" runat="server" CssClass="section">
			<div class="sectionEven">
				...
				<ul>
					...
					<li id="liMinCharsRequired" runat="server">
						<label>
							Minimum characters required</label>
						<asp:TextBox ID="tbxMinimumCharactersRequired" runat="server" />
					</li>
					<li id="liMaxCharsAllowed" runat="server">
						<label>
							Maximum characters allowed</label>
						<asp:TextBox ID="tbxMaximumCharactersAllowed" runat="server" />
					</li>
					<li id="liAllowOnlyNumericValues" runat="server">
						<label>
							Allow only numeric values</label>
						<asp:CheckBox ID="chkAllowOnlyNumericValues" runat="server" AutoPostBack="True" Text="" />
					</li>
