<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InterfaceReceivingTicketStatus.aspx.vb" Inherits="KahlerAutomation.TerminalManagement2.InterfaceReceivingTicketStatus" EnableViewState="true" %>

<!DOCTYPE html>
<html lang="en">
<head id="Head1" runat="server">
    <title>Interfaces : Ticket Receiving Export Status</title>
...
<body>
    <form id="main" runat="server" method="post">
        <asp:ScriptManager ID="ToolkitScriptManager1" runat="server" AsyncPostBackTimeout="3600"
            AsyncPostBackErrorMessage="Timeout while retrieving exported ticket data." OnAsyncPostBackError="ScriptManager1_AsyncPostBackError">
        </asp:ScriptManager>
                ...
                <div class="section" id="pnlMain">
                    <div class="sectionEven" id="ticketDisplayOptions" runat="server" style="text-align: left; vertical-align: top;">
                        ...
                        <asp:CheckBox ID="chkOnlyIncludeOrdersForThisInterface" runat="server" AutoPostBack="true"
                            Text="Only include purchase orders assigned for this interface" Checked="true" Style="margin-left: 40px;" /><br />
                    ...
                    <div class="sectionOdd" id="ticketSortOptions" runat="server">
                        ...
                        <asp:DropDownList ID="ddlSortBy" runat="server" AutoPostBack="true">
                            ...
                            <asp:ListItem Text="Received date (Asc)" Value="ReceivedAtDateAsc"></asp:ListItem>
                            <asp:ListItem Text="Received date (Desc)" Value="ReceivedAtDateDesc"></asp:ListItem>
