...
Public Class CustomerMasterFile : Inherits System.Web.UI.Page
...
#Region "Events"
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If Not Page.IsPostBack Then
			PopulateCustomerList(_currentUser)
	...
	Protected Sub btnPrinterFriendly_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPrinterFriendly.Click
		ClientScript.RegisterClientScriptBlock(Me.GetType(), "ShowReport", Utilities.JsWindowOpen("CustomerMasterFileView.aspx"))
	End Sub

	Protected Sub btnDownload_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDownload.Click
		Dim fileName As String = String.Format("AllCustomers{0:yyyyMMddHHmmss}.csv", Now)
		KaReports.CreateCsvFromTable("All customers", KaReports.GetCustomerTable(GetUserConnection(_currentUser.Id), _currentUser), DownloadDirectory(Me) & fileName)
		ClientScript.RegisterClientScriptBlock(Me.GetType(), "DownloadReport", Utilities.JsWindowOpen("./download/" & fileName))
	End Sub
#End Region

	Private Sub PopulateCustomerList(ByVal currentUser As KaUser)
		litReport.Text = KaReports.GetTableHtml("All customers", KaReports.GetCustomerTable(GetUserConnection(currentUser.Id), currentUser))
	End Sub
...
#Region " E-mail report "
	...
	Protected Sub btnSendEmail_Click(sender As Object, e As EventArgs) Handles btnSendEmail.Click
		...
		If tbxEmailTo.Text.Trim().Length > 0 Then
			Dim header As String = "All customers"
			Dim body As String = KaReports.GetTableHtml("All customers", KaReports.GetCustomerTable(GetUserConnection(_currentUser.Id), _currentUser))
			...
			For Each emailRecipient As String In emailTo
				If emailRecipient.Trim.Length > 0 Then
					...
					attachments.Add(New System.Net.Mail.Attachment(New IO.MemoryStream(Encoding.UTF8.GetBytes(newEmail.Body)), "AllCustomersReport.html", System.Net.Mime.MediaTypeNames.Text.Html))
