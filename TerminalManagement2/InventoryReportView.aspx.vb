...
#End Region
    ...
    Private Sub PopulateReport(ByVal currentUser As KaUser)
        ...
        Dim assignPhysicalInventoryToTankOwner As Boolean = False
        If Page.Request("AssignPhysicalByOwner") IsNot Nothing Then Boolean.TryParse(Page.Request("AssignPhysicalByOwner"), assignPhysicalInventoryToTankOwner)
        ...
        Dim reportDataList As ArrayList = KaReports.GetInventoryTable(connection, ownerId, locationId, bulkProductIds, onlyNonzeroEntries, KaReports.MEDIA_TYPE_HTML, assignPhysicalInventoryToTankOwner, "", GetAdditionalUnitIds(additionalUnitIdsString), "")
        ...
        litReport.Text = KaReports.GetTableHtml("Inventory Report", reportTitle, reportDataList, True, tableAttributes, headerRowAttributes, headerCellAttributeList, rowAttributes, detailCellAttributeList)
    End Sub
