<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ArchiveOrders.aspx.vb"
	Inherits="KahlerAutomation.TerminalManagement2.ArchiveOrders" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html>
<html lang="en">
<head id="Head1" runat="server">
	<title>Orders : Archive Orders</title>
		...
		<asp:UpdatePanel ID="PleaseWaitPanel" runat="server" RenderMode="Inline">
			<ContentTemplate>
				...
				<div id="pnlOrdersArea" runat="server" class="section">
					<div id="pnlOrders" runat="server" class="section">
						<h1>Orders</h1>
