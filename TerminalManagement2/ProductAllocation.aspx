<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProductAllocation.aspx.vb"
	Inherits="KahlerAutomation.TerminalManagement2.ProductAllocation" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html>
<html lang="en">
<head runat="server">
	<title>Products : Product Allocation</title>
	...
	<div class="recordSelection">
		...
		<ul>
			...
			<li>
				...
				<asp:CheckBox ID="cbxOnlyShowProductsWithBulkProductsAtLocation" runat="server" Text=""
					Checked="true" />
			</li>
		</ul>
	</div>
