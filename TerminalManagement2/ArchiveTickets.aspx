<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ArchiveTickets.aspx.vb"
	Inherits="KahlerAutomation.TerminalManagement2.ArchiveTickets" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html>
<html lang="en">
<head id="Head1" runat="server">
	<title>Orders : Archive Tickets</title>
	...
	<form id="main" runat="server" defaultfocus="btnFilter" defaultbutton="btnFilter">
		...
		<asp:UpdatePanel ID="PleaseWaitPanel" runat="server" RenderMode="Inline">
			<ContentTemplate>
				...
				<div id="pnlTicketArea" runat="server" class="section">
