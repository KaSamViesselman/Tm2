...
Public Class InterfaceTicketStatusView : Inherits System.Web.UI.Page
...
#Region "Events"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            litReport.Text = KaReports.GetTableHtml(header, "", KaReports.GetInterfaceTicketExportStatusReport(GetUserConnection(New Guid(userId)), New Guid(interfaceId), sortBy, showTicketsExported, includeTicketsMarkedManually, includeTicketsWithError, includeTicketsWithIgnoredError, limitOrdersToInterface))
        End If
    End Sub
#End Region
End Class